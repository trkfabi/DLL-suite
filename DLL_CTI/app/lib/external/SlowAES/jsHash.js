 ...
 * @version 3.0
 * @class Lib.utils.SlowAES.jsHash
 */
 ...
 * 
 * 2017 - Modified for Titanium SDK 6.0.1.GA by Carlos Enciso from Propelics Inc. ( http://www.propelics.com/ )
 *
...
var jsHash = (function () {
	var sha2 = {
			...
			for (var i = 0; i < m.length; i += 16) {
				...
				for (var j = 0; j < 64; j++) {
					if (j < 16)
						...
						W[j] = this.safe_add(this.safe_add(this.safe_add(this.Gamma1256(W[j - 2]), W[j - 7]), this.Gamma0256(W[j - 15])),
							W[j - 16]);

					T1 = this.safe_add(this.safe_add(this.safe_add(this.safe_add(h, this.Sigma1256(e)), this.Ch(e, f, g)), K[j]),
						W[
							j]);
		...
		arr_sha256: function (s) {
			return this.binb2arr(this.core_sha256(this.str2binb(s), s.length * this.chrsz));
		},
		str_sha256: function (s) {
			return this.binb2str(this.core_sha256(this.str2binb(s), s.length * this.chrsz));
		}
	};
