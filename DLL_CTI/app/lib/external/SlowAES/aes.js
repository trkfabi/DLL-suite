...
var slowAES = (function () {
	...
	var aes = {
		...
		rsbox: [,
	...
	function getBlock(bytesIn, start, end, mode) {
		if (end - start > 16)
			end = start + 16;
	 ...
	 */
	function encrypt(bytesIn, mode, key, iv) {
		var size = key.length;
		if (iv.length % 16) {
	 ...
	 * iv - the 128 bit number array Initialization Vector
	 */
	function decrypt(cipherIn, mode, key, iv) {
		var size = key.length;
		if (iv.length % 16) {
			throw 'iv length must be 128 bits.';
		}
	...
	return {
		...
		encrypt: encrypt,
		decrypt: decrypt,
		padBytesIn: padBytesIn,
		unpadBytesOut: unpadBytesOut
	};
})();
