...
const LOG_TAG = '[apis/othc/rate_program_create]';

/**
 * @class Apis.rate_cards.othc.rate_program.create
 * POST /api/rate_cards/othc/rate_program/create
 */
const API = Arrow.API.extend({
	group: 'rateProgram',
	path: '/api/rate_cards/othc/rate_program/create',
	method: 'POST',
	description: 'Creates a new rate program for the given version',
	parameters: {
		'versionId': {
			type: 'body',
			description: 'Version to add the rate program',
			optional: false
		},
		'name': {
			type: 'body',
