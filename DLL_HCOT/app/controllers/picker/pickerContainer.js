...
var MAX_LIST_HEIGHT = (Alloy.Globals.hasNotch) ? 252 : 180;
var options = [];
var slideAnimation;
var fadeAnimation;
 ...
 */
function createList() {
	var rowHeight = (Alloy.Globals.hasNotch) ? 41 : 40;
	var rows = [];
	...
	var listHeight = Math.min(MAX_LIST_HEIGHT, rows.length * rowHeight);
