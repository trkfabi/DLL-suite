...
/**
 * @method updateAdvancePaymentAnalytics
 * @private
 * Adds a counter to the property counter
 * @param {Object} _value.advancePayment Advance payment number
 * @param {Object} _value.advancePaymentType Advance payment type
 * @return {void}
 */
function updateAdvancePaymentAnalytics(_value) {
	doLog && console.log('[advancePaymentPickerRow] - updateAdvancePaymentAnalytics');
	paymentOption.addAnalyticsCounter('advancePayment', _value);
}
		...
		appNavigation.openPickerWindow({
			...
			callback: function (_rowSelected) {
				if (_rowSelected) {
					...
					updateAdvancePaymentAnalytics(value);
