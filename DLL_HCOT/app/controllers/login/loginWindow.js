...
function handleAppStatusChange(_evt) {
	doLog && console.log('[loginWindow] - handleAppStatusChange ' + _evt.type);
...
function handleNetworkChange(_evt) {
	doLog && console.log('[loginWindow] - handleNetworkChange is online: ' + _evt.networkOnline);
