...
function init() {
	...
	analytics.captureEvent('[solveForWindow] - init()');
	...
	uiHelpers.addDoneButton($.paymentValueField, handleTextFieldBlur);
	uiHelpers.addDoneButton($.equipmentValueField, handleTextFieldBlur);
	uiHelpers.addDoneButton($.additionalCostValueField, handleTextFieldBlur);
...
function resetValues() {
	analytics.captureEvent('[solveForWindow] - resetValues()');
...
function acceptValues() {
	analytics.captureEvent('[solveForWindow] - acceptValues()');
